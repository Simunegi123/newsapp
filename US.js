const  main = document.getElementById('articles-content');

let data;
let dataLength=0;

async function getData(){
    const res = await fetch('https://newsapi.org/v2/top-headlines?country=us&apiKey=48d85ecb6b1a44d9a65176f5447c2032');
